...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (PrefsUtil.with(mContext).readBoolean("isLoggedIn")) {
            if (new ConnectionCheck().isNetworkConnected(LoginActivity.this)) {
...
//                    intent = new Intent(mContext, HomeActivity.class);
                    ...
                    Intent i = new Intent(LoginActivity.this, UserEditProfileActivity.class);
...
//        edtPassword = (EditText) findViewById(R.id.edtPassword);
        sign_in_button = (RelativeLayout) findViewById(R.id.sign_in_button) ;
...
//        ku.setupUI(activity_login, LoginActivity.this);
    }
            ...
            public void onResult(boolean status, Object obj) {
                if (status) {
                    ...
                    if (resultObj.isStatus()) {
                        //Toast.makeText(LoginActivity.this, resultObj.getMessage(), Toast.LENGTH_SHORT).show();
                        SocialLoginItem loginData = resultObj.getSocialLogin().get(0);
                        if (loginData.getRegister().equalsIgnoreCase("y")) {
                            Intent i = new Intent(LoginActivity.this, UserEditProfileActivity.class);
                            i.putExtra("from", "signup");
                            PrefsUtil.with(LoginActivity.this).clearPrefs();
                            PrefsUtil.with(LoginActivity.this).write("isLoggedIn", true);
                            PrefsUtil.with(LoginActivity.this).write("completeProfile", false);
                            ...
                            PrefsUtil.with(LoginActivity.this).write("paypalEmail", loginData.getPaypalEmail());
                            PrefsUtil.with(LoginActivity.this).write("password", loginData.getPassword());
                            startActivity(i);
                            //finish();
                        } else {
                            if (TextUtils.isEmpty(loginData.getMobileNo().toString()) || TextUtils.isEmpty(loginData.getDefaultPaymentMethod().toString())) {
                                ...
                                registerDeviceFromSocial(loginData);
                                    ...
                                    /*PrefsUtil.with(LoginActivity.this).write("completeProfile",true);
                                    PrefsUtil.with(LoginActivity.this).write("isLoggedIn",true);
                                    PrefsUtil.with(LoginActivity.this).write("uId",loginData.getUId());
                                    PrefsUtil.with(LoginActivity.this).write("firstName",loginData.getFirstName());
                                    PrefsUtil.with(LoginActivity.this).write("lastName",loginData.getLastName());
        ...
        new ParseJSON(mContext, url, params, values, CommonPOJO.class, new ParseJSON.OnResultListner() {
            ...
            public void onResult(boolean status, Object obj) {
                if (status) {
                    ...
                    PrefsUtil.with(LoginActivity.this).write("firstName", loginData.getFirstName());
                    PrefsUtil.with(LoginActivity.this).write("lastName", loginData.getLastName());
                    PrefsUtil.with(LoginActivity.this).write("profileImage", WebServiceUrl.profileUrl + loginData.getUId() + "/" + loginData.getProfileImage());
                    PrefsUtil.with(LoginActivity.this).write("mobileNo", loginData.getMobileNo());
                    PrefsUtil.with(LoginActivity.this).write("email", loginData.getEmail());
                    PrefsUtil.with(LoginActivity.this).write("paypalEmail", loginData.getPaypalEmail());
                    PrefsUtil.with(LoginActivity.this).write("password", loginData.getPassword());
    ...
    public void loginWithCreds(String strEmail, String strPassword) {
        ...
        new ParseJSON(LoginActivity.this, WebServiceUrl.ServiceUrl + WebServiceUrl.userlogin, params, values, LoginPOJO.class, new ParseJSON.OnResultListner() {
            @Override
            public void onResult(boolean status, Object obj) {
                if (status) {
                    ...
                    if (loginObj.isStatus()) {
                        ...
                        if (loginObj.getDataAns().get(0).getIsActive().equalsIgnoreCase("y")) {
                            //Toast.makeText(LoginActivity.this, loginObj.getMessage(), Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(LoginActivity.this, (String) obj, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
