...
public class HomeLocationActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new KeyboardUtils().setupUI(findViewById(R.id.activity_work_location), HomeLocationActivity.this);
            ...
            public void onClick(View v) {
               //Log.e("WorkLocation", "Lat & Long : ");
                ...
                if (!TextUtils.isEmpty(location)) {
                    ...
                    Toast.makeText(HomeLocationActivity.this, "Please select location", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                try {
                    if (getIntent().getBooleanExtra("dataAvailable",false)) {
                        ...
                        GPSTracker gpsTracker = new GPSTracker(HomeLocationActivity.this);
    ...
    private void setupToolbar() {
        ...
        txtTitle.setText(R.string.home_location_title);
    ...
    private AdapterView.OnItemClickListener
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Log.i("HomeLocationActivity", "Autocomplete item selected: " + item.description);
            PendingResult<PlaceBuffer> placeResult = Places.GeoDataApi.getPlaceById(mGoogleApiClient, placeId);
            placeResult.setResultCallback(mUpdatePlaceDetailsCallback);
            //Toast.makeText(HomeLocationActivity.this, "Clicked: " + item.description, Toast.LENGTH_SHORT).show();
            Log.i("HomeLocationActivity", "Called getPlaceById to get Place details for " + item.placeId);
        }
    };
    ...
    private ResultCallback<PlaceBuffer> mUpdatePlaceDetailsCallback = new ResultCallback<PlaceBuffer>() {
        ...
        public void onResult(PlaceBuffer places) {
            if (!places.getStatus().isSuccess()) {
                Log.e("HomeLocationActivity", "Place query did not complete. Error: " + places.getStatus().toString());
                places.release();
                return;
            }else {
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Log.e("HomeLocationActivity", "onConnectionFailed: ConnectionResult.getErrorCode() = "
    ...
    public void setHomeLocation(){
        ...
        new ParseJSON(HomeLocationActivity.this, WebServiceUrl.ServiceUrl+WebServiceUrl.usereditlocation, params, values, CommonPOJO.class, new ParseJSON.OnResultListner() {
            @Override
            public void onResult(boolean status, Object obj) {
                if (status) {
                    CommonPOJO resultObj = (CommonPOJO) obj;
                    Toast.makeText(HomeLocationActivity.this, resultObj.getMessage(), Toast.LENGTH_SHORT).show();
                    Intent resultIntent = new Intent();
                    setResult(RESULT_OK,resultIntent);
                    finish();
                    //String loginObj = (String) obj;
                }else {
                    Toast.makeText(HomeLocationActivity.this, (String) obj, Toast.LENGTH_SHORT).show();
                }
    ...
    public void setMarker(final LatLng point){
        /*try {
            ...
            if (address != null) {
                ...
                Toast.makeText(HomeLocationActivity.this, sb.toString(), Toast.LENGTH_LONG).show();
            }
            ...
            marker = map.addMarker(new MarkerOptions().position(point).title("Home")
                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.pick_up_marker)));
            moveToCurrentLocation(selectedLatLng);
        } catch (Exception e) {
            Toast.makeText(HomeLocationActivity.this, "Cannot get address from clicked location", Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }*/
                ...
                try {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            gHelper.fetchAddress(HomeLocationActivity.this, temp,
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(HomeLocationActivity.this,
        ...
        try {
            if (event.getType().equalsIgnoreCase("connection")) {
                if (event.getMessage().equalsIgnoreCase("disconnected")) {
                    if (!(new ConnectionCheck().isNetworkConnected(HomeLocationActivity.this))) {
                        ...
                        if (!ApplicationController.isOnline) {
                            ...
                            final Dialog d = new Dialog(HomeLocationActivity.this,
