...
public class SocialLoginItem{
	...
	@SerializedName("onlineWithCarId")
	@Expose
	private String onlineWithCarId;
	...
	@SerializedName("onlineWithCarTypeId")
	@Expose
	private String onlineWithCarTypeId;

	@SerializedName("isUnderRide")
	@Expose
	private String isUnderRide;
	...
	public void setOnlineWithCarId(String onlineWithCarId){
		this.onlineWithCarId = onlineWithCarId;
	}

	public String getOnlineWithCarId(){
		return onlineWithCarId;
	}
	...
	public void setOnlineWithCarTypeId(String onlineWithCarTypeId){
		this.onlineWithCarTypeId = onlineWithCarTypeId;
	}

	public String getOnlineWithCarTypeId(){
		return onlineWithCarTypeId;
	}

	public void setIsUnderRide(String isUnderRide){
		this.isUnderRide = isUnderRide;
	}

	public String getIsUnderRide(){
		return isUnderRide;
	}
	...
	public void setLastRideId(String lastRideId){
